import 'package:dkb_retail/core/utils/ui_components/components/src/ui_shimmer.dart';
...
class UIShimmerWidget extends StatelessWidget {
  ...
  const UIShimmerWidget.circle({super.key, this.height = 50, this.width = 50})
    : cornerEdge = null,
      shape = BoxShape.circle,
      shimmerFilled = ShimmerFilled.filled,
      child = null;

  const UIShimmerWidget.textBox({super.key, this.height = 10, this.width = 50})
    : cornerEdge = 8,
      shimmerFilled = ShimmerFilled.filled,
      child = null,
      shape = BoxShape.rectangle;
    ...
    return UIShimmer(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: cornerEdge != null
              ? BorderRadius.circular(cornerEdge!)
              : null,
        ),
      ),
    );
