...
class _WalletScreenState extends State<WalletScreen>
  ...
  void initState() {
    ...
    // --- Initialize video asset here ---
    _videoController =
        VideoPlayerController.asset("assets/video/Intro-Screen-Video.mp4")
          ..initialize().then((_) {
    ...
    _timer = Timer.periodic(const Duration(seconds: 4, milliseconds: 700), (_) {
      if (!mounted) return;
      setState(() {
  ...
  void dispose() {
    ...
    _videoController.dispose(); // dispose video
