                  ...
                  children: [
                    Expanded(
                      child: ActionButtonWidget(
                        ...
                        onPressed: () {
                          int scanAttempts =
                              ref.watch(scanAgainAttemptsProvider) + 1;
                          if (scanAttempts >= 6) {
                            ref.read(scanAgainAttemptsProvider.notifier).state =
                                0;
                            ref
                                .read(
                    ...
                    Expanded(
                      child: ActionButtonWidget(
                        ...
                        onPressed: () async {
                          ...
                          if (value == true) {
                            context.router.push(
                              OnboardingVerifyIdentifySelfieRoute(),
                            );
                          } else {
  ...
  Widget _buildInfoField(String title, String value) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          UiTextNew.h4Regular(title, color: DefaultColors.white_800),
