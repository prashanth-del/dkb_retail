...
class OnboardingSelectBranchPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OnboardingSelectBranchPage> createState() =>
      _OnboardingSelectBranchPageState();
}

class _OnboardingSelectBranchPageState
    extends ConsumerState<OnboardingSelectBranchPage> {
          ...
          children: [
            ...
            Padding(
              ...
              child: UIButton.rounded(
                ...
                isDisabled:
                    selectedBranch.isEmpty && currencyController.text.isEmpty,
                onPressed: () async {
                  ...
                  bool value = await ref
                      ...
                      .fetch(
                        ...
                        data: {
                          "Product_Type": _selectedIndex != 0
                              ? "Current Account"
                              : "Savings Account",
                          "Branch_Selected": selectedBranch.isEmpty
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      setState(() {
                        currencyController.text = list == 'Please Select'
                            ? ''
                            : list;
                      });
                    },
...
final List<AccountOption> _options = [
  AccountOption(
    ...
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec quam a urna egestas mattis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec quam a urna egestas mattis. ",
  ),
  AccountOption(
    title: "Current Account",
    description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nec quam a urna egestas mattis. dipiscing elit. Morbi nec quam a urna egestas mattis.",
  ),
];
