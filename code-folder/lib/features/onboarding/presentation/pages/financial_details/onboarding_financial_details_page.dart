...
class OnboardingFinancialDetailsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OnboardingFinancialDetailsPage> createState() =>
      _OnboardingFinancialDetailsPageState();
}

class _OnboardingFinancialDetailsPageState
    extends ConsumerState<OnboardingFinancialDetailsPage> {
              ...
              onPressed: () async {
                bool value = await ref
                    ...
                    .fetch(
                      ...
                      data: {"Financial_details": selectedOption},
                    );
