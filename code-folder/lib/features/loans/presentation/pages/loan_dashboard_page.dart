...
class LoanDashboardPage extends ConsumerStatefulWidget {
  const LoanDashboardPage({super.key});

  @override
  ConsumerState<LoanDashboardPage> createState() => _LoanDashboardPageState();
}

class _LoanDashboardPageState extends ConsumerState<LoanDashboardPage> {
  // int? _expandedIndex;
      ...
      child: Directionality(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildLoansInfoCard(tabsRouter),
  ...
  Widget _buildLoansInfoCard(TabsRouter tabsRouter) {
    return Container(
      height: 122,
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
            AssetPath.image.loansFrameImage,
          ), // Path to your image
          fit: BoxFit
