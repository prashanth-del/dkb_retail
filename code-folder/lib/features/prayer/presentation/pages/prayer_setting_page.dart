  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AuthHeaderWrapper(
        headerText: DefaultString.instance.prayerTimeSettings,
        showBackButton: true,
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: UiCard(
                ...
                child: Row(
                  children: [
                    Icon(Icons.calendar_month, color: Colors.black54, size: width * 0.05),
                    SizedBox(width: width * 0.03),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                          DefaultString.instance.hijriDate,
                          style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: width * 0.035,
                          ),
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          icon: Icon(
                            Icons.remove_circle,
                            color: value > 0 ? const Color(0xFF4197CB) : Colors.grey,
                            size: width * 0.07,
                          ),
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                IconData icon;
                switch (prayer) {
                  case 'Fajr': icon = Icons.wb_sunny_outlined; break;
                  case 'Sunrise': icon = Icons.wb_sunny; break;
                  case 'Dhuhr': icon = Icons.light_mode; break;
                  case 'Asr': icon = Icons.cloud; break;
                  case 'Maghrib': icon = Icons.nights_stay; break;
                  case 'Isha': icon = Icons.dark_mode; break;
                  ...
                  child: UiCard(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: () => setState(() => prayerTimes[prayer] = time.subtract(const Duration(minutes: 1))),
                          icon: Icon(Icons.remove_circle, color: const Color(0xFF4197CB), size: width * 0.07),
                          splashRadius: width * 0.07,
                        ),
                        SizedBox(
                          width: width * 0.18,
                          child: InkWell(
                            onTap: () async {
                              ...
                              if (picked != null) {
                                setState(() {
                                  prayerTimes[prayer] = DateTime(time.year, time.month, time.day, picked.hour, picked.minute);
                                });
                              }
                            },
                            child: Text(
                        ...
                        IconButton(
                          onPressed: () => setState(() => prayerTimes[prayer] = time.add(const Duration(minutes: 1))),
                          icon: Icon(Icons.add_circle, color: const Color(0xFF4197CB), size: width * 0.07),
                          splashRadius: width * 0.07,
                        ),
                      ],
                    ),
