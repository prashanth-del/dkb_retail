...
class _UserInterestsPageState extends ConsumerState<UserInterestsPage> {
  ...
  bool isAnyInterestSelected(List<dynamic> interests) {
    return interests.any((item) => item['checked'] == true);
  }

  @override
  Widget build(BuildContext context) {
    final hasSelected = isAnyInterestSelected(userInterests);
    return Scaffold(
      resizeToAvoidBottomInset: true,
      backgroundColor: DefaultColors.white,
      body: AuthHeaderWrapper(
        headerText: DefaultString.instance.yourInterests,
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: UiTextNew.b1Semibold(
                DefaultString
                    .instance
                    .selectYourInterestsToCurateYourExperience,
                maxLines: 2,
              ),
            ),
            UiSpace.vertical(20),
          ...
          children: [
            Container(
              ...
              child: UIButton.rounded(
                ...
                label: DefaultString.instance.completeRegistration,
              ),
            ),
            GestureDetector(
              onTap: () {
              ...
              child: Container(
                ...
                child: Center(
                  child: UiTextNew.h5Medium(
                    DefaultString.instance.skipForNow,
            ...
            Padding(
              ...
              child: Center(
                child: UiTextNew.b3Medium(
                  DefaultString.instance.youCanSetYourInterestLaterOnceYouLogin,
