        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                title,
                style: UiTextStyles.uiTitleStyle(
                  context,
                )?.copyWith(color: DefaultColors.white_900),
              ),
              const UiSpace.vertical(16),
              Padding(
                ...
                child: Text(
                  ...
                  style: UiTextStyles.uiInfoTitleSmall(
                    context,
                  )?.copyWith(color: DefaultColors.white_700),
                ),
              ),
            ],
          ),
