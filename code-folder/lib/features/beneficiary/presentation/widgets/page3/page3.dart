...
class Page3 extends ConsumerStatefulWidget {
  ...
  const Page3({super.key, required this.onBack, required this.onSubmit});
      ...
      child: Column(
        children: [
          ...
          if (isAddBeneficiary) ...[
            ...
            (cardReset
                ? ViewCardReset(isCountry: isIndia)
                : IfscCodeCard(isCountry: isIndia)),
          ] else ...[
                      ...
                      if (isAddBeneficiary) {
                        if (cardReset) {
                          viewBottomSheet(
                            ...
                            child: const ConfirmBeneficiaryCard(),
                          );
                        }
                      } else {
                        viewBottomSheet(
