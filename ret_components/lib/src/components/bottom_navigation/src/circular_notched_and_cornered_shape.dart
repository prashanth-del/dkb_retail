...
import '../ui_bottom_navigation_bar.dart';
import 'package:flutter/animation.dart';
import 'package:flutter/painting.dart';
import 'gap_location_exceptions.dart';
    ...
    if (guestCenterDx == halfOfHostWidth) {
      if (gapLocation == GapLocation.end) {
        throw GapLocationException(
            'Wrong gap location in $UIBottomNavigationBar towards FloatingActionButtonLocation => '
