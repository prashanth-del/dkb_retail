...
class UIInputFieldRetail extends StatefulWidget {
  ...
  const UIInputFieldRetail.outlined({
  ...
  const UIInputFieldRetail.underlined({
    required this.hintText,
    this.helperText,
    this.controller,
    this.initialValue,
  ...
  @override
  State<UIInputFieldRetail> createState() => _UIInputFieldRetailState();
}

class _UIInputFieldRetailState extends State<UIInputFieldRetail> {
